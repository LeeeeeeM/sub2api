export default {
    settings: {
      ...
      oidc: {
        ...
        logoutUrl: 'SSO Logout URL',
        logoutUrlPlaceholder: 'Optional, for example https://sso.example.com/logout',
        logoutUrlHint: 'Optional; redirect here after signing out of Sub2API. Independent from OIDC Discovery.',
        clientId: 'Client ID',
      ...
      site: {
        ...
        availableModelsEnabled: 'Show Available Models',
        availableModelsEnabledHint: 'When enabled, the "View Available Models" action will be shown on the API Keys page'
      },
      purchase: {
