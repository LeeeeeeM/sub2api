export default {
    settings: {
      ...
      oidc: {
        ...
        logoutUrl: 'SSO 退出地址',
        logoutUrlPlaceholder: '可选，例如 https://sso.example.com/logout',
        logoutUrlHint: '可选；退出 Sub2API 后跳转到此地址，不影响 OIDC Discovery 配置',
        clientId: 'Client ID',
      ...
      site: {
        ...
        availableModelsEnabled: '显示查看可用模型',
        availableModelsEnabledHint: '启用后将在 API Keys 页面操作中显示"查看可用模型"按钮'
      },
      purchase: {
        title: '充值/订阅页面',
